...
import com.sosv.breweryDB.connector.service.beer.async.BeerServiceAsyncTests;
...
@RunWith(Suite.class)
@SuiteClasses({ FilterMultivalueMapBuilderTests.class, BeerResourceTests.class,
		BreweryResourceTests.class, SearchTests.class,
		BeerServiceAsyncTests.class })
